...
namespace Managers
{
    public class PlayerManager : MonoBehaviour
    {
        ...
        private void SubscribeEvents()
        {
            ...
            CoreGameSignals.Instance.onMiniGameStageAreaEntered += OnStageAreaEntered;
            CoreGameSignals.Instance.onMiniGameStageAreaSuccessful += OnStageAreaSuccessful;
        ...
        private void OnMiniGameStageAreaEntered()
        {
            movementController.IsReadyToPlay(false);
        }

        private void OnMiniGameStageAreaSuccessful(byte stageID)
        {
            movementController.IsReadyToPlay(true);
        }
